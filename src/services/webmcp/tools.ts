...
/** Canonical definitions consumed by the runtime registration and documentation. */
export function createLenseTools(control:ReturnType<typeof useControlStore>,bridge:ReturnType<typeof useBridgeStore>,getAvailability:()=>string = ()=>'local'): Tool[] {
